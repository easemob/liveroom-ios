...
- (LRSearchResultController *)resultController
{
    return objc_getAssociatedObject(self, ResultControllerKey);
}

- (void)setResultController:(LRSearchResultController *)resultController
{
...
- (void)setResultNavigationController:(LRSearchResultController *)resultNavigationController
{
...
- (void)enableSearchController
{
    ...
    if (self.searchButton == nil) {
        ...
        self.searchButton.backgroundColor = LRColor_LightGray;
    ...
    if (self.resultNavigationController == nil) {
        self.resultController = [[LRSearchResultController alloc] init];
...
{
    if ([self conformsToProtocol:@protocol(TCSearchControllerDelegate)]
